...
import com.example.lokalin.ui.search.SearchFragmentDirections
import java.text.NumberFormat
import java.util.Locale

class RecommendationAdapterSearch :  ListAdapter<ProductItem, RecommendationAdapterSearch.MyViewHolder>(
    DIFF_CALLBACK
) {
