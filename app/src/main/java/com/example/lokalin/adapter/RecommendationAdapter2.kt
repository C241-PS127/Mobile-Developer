...
import com.example.lokalin.ui.profile.ProfileFragmentDirections
import java.text.NumberFormat
import java.util.Locale

class RecommendationAdapter2 : PagingDataAdapter<ProductsItem, RecommendationAdapter2.MyViewHolder>(
    DIFF_CALLBACK
) {
