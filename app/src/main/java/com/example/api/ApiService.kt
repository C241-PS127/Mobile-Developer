...
interface ApiService {
    ...
    suspend fun deleteWishlist(@Header("Authorization") token: String, @Path("wishlistId") wishlistId: String): List<WishlistResponseItem>
    ...
    @FormUrlEncoded
    @POST("cart")
    suspend fun addCart(@Header("Authorization") token: String,
